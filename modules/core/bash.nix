      ...
      { config, ... }:
      {
        programs.bash = {
          ...
          sessionVariables = {
            ...
            # Native libs for Hermes local STT (faster-whisper / PyAV).
            # Use gcc16's libstdc++: Hyprland 0.56.2+ binaries require
            # GLIBCXX_3.4.35/36, which gcc-15.3.0's libstdc++ doesn't provide.
            LD_LIBRARY_PATH = "${pkgs.zlib}/lib:${pkgs.gcc16.cc.lib}/lib";
          };
          shellAliases = {
            lf = ''
                {
